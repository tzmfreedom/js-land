...
const ApexCrypto = new ApexClass(
  'Crypto',
  null,
  [],
  [],
    ...
    decrypt: [
      createMethodNode(
        ...
        () => {
          ...
          const cipherText = CryptoJS.enc.Hex.parse(cipherText.toString('hex'))
          ...
          const algorithmFunctions = {
            AES128: CryptoJS.HmacMD5,
            AES192: CryptoJS.HmacSHA1,
            AES256: CryptoJS.HmacSHA256,
          }
      ...
      createMethodNode(
        ...
        () => {
          ...
          if (!algorithmFunctions.includes(algorithmName)) {
            throw `Invalid Crypto Algorithm`
          }
