...
const ApexJSON = new Ast.ApexClass(
  'JSON',
  null,
  [],
  [],
  ...
  },
  {
    ...
    serialize: [
      createMethodNode(
        ...
        () => {
          const object = EnvManager.getValue('objectToSerialize')
          const result = {}
          Object.keys(object._data).forEach((key) => {
            result[key] = object._data[key].value
          })
          return new Ast.StringNode(JSON.stringify(result))
        }
      ),
      createMethodNode(
        'serialize',
