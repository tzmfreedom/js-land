...
// Enter a parse tree produced by apexParser#whereFields.
apexListener.prototype.enterWhereFields = function (ctx) {
}

// Exit a parse tree produced by apexParser#whereFields.
apexListener.prototype.exitWhereFields = function (ctx) {
}
...
apexListener.prototype.enterSoslLiteral = function (ctx) {
}

// Exit a parse tree produced by apexParser#soslLiteral.
apexListener.prototype.exitSoslLiteral = function (ctx) {
}

// Enter a parse tree produced by apexParser#soslQuery.
apexListener.prototype.enterSoslQuery = function (ctx) {
}

// Exit a parse tree produced by apexParser#soslQuery.
apexListener.prototype.exitSoslQuery = function (ctx) {
}

// Enter a parse tree produced by apexParser#soslReturningObject.
apexListener.prototype.enterSoslReturningObject = function (ctx) {
}

// Exit a parse tree produced by apexParser#soslReturningObject.
apexListener.prototype.exitSoslReturningObject = function (ctx) {
}

// Enter a parse tree produced by apexParser#apexIdentifier.
apexListener.prototype.enterApexIdentifier = function (ctx) {
}

// Exit a parse tree produced by apexParser#apexIdentifier.
apexListener.prototype.exitApexIdentifier = function (ctx) {
}

// Enter a parse tree produced by apexParser#typeIdentifier.
apexListener.prototype.enterTypeIdentifier = function (ctx) {
}

// Exit a parse tree produced by apexParser#typeIdentifier.
apexListener.prototype.exitTypeIdentifier = function (ctx) {
}
