...
// Visit a parse tree produced by apexParser#specialComment.
apexVisitor.prototype.visitSpecialComment = function(ctx) {
  return this.visitChildren(ctx);
};
...
// Visit a parse tree produced by apexParser#soqlField.
apexVisitor.prototype.visitSoqlField = function(ctx) {
  return this.visitChildren(ctx);
};
