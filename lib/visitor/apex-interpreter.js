...
const methodResolver = require('../interpreter/method-resolver')
const variableResolver = require('../interpreter/variable-resolver')
...
class ApexInterpreter {
  ...
  visitBinaryOperator (node) {
    ...
    const klassName = node.left.type().name.join('.')
